...
The format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/), and releases should follow [Semantic Versioning](https://semver.org/spec/v2.0.0.html) while the API matures.
...
- Initial `GaussianHSMM` estimator.
- Diagonal and full Gaussian covariance models.
- Shifted-Poisson explicit state-duration distributions.
- Explicit-duration forward-backward inference and Viterbi decoding.
